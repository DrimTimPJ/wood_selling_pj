          ...
          <div className="pl-5 md:flex md:justify-around xl:pl-20 lg:pl-10">
            <div className="w-[100%]">
              ...
              <div className="w-[80%] mt-5 text-[14px] md:text-[24px] lg:text-[30px] xl:text-[42px]">
                <strong>BIO CWT</strong> - ми виготовляємо вироби з масиву дерева за індивідуальними кресленнями. 
                Ми виготовляємо стільці, крісла, шафи, ліжка та багато іншого у власній майстерні, 
